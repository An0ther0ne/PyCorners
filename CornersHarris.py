#-*- coding: utf-8 -*-
# В OpenCV існує метод cornerHarris, який дозволяє знаходити кутики на картинці. 
# В параметрах, крім зображення, він приймає коефіцієнти, які впливають на кількість і якість отриманих точок. 
# В документації рекомендують почати з дефолтних значень і змінювати їх при потребі.
